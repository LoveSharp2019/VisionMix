...
{
    public partial class OcrHandToolUnit : ToolsSettingUnit
    {
        OcrHandTool tool;
        ...
        public OcrHandToolUnit(OcrHandTool tool)
        {
            InitializeComponent();
        ...
        private void Init()
        {
            ...
            UpDownDynThreadVal.Value = (decimal)tool.DynThreadVal;
            UpDownOpenR.Value = (decimal)tool.OpenCircleRadius;
            UpDownCloseR.Value = (Decimal)tool.CloseCircleRadius;


            UpDownMaxCharHeight.Value = tool.MaxCharHeight;
            ...
            UpDownMinArea.Value =(decimal) tool.MinCharArea;
            UpDownMaxArea.Value = (decimal)tool.MaxCharArea;

            UpDownPartitionCharWidth.Value = tool.PartitionCharWidth;
        ...
        private void UpDownDynThreadVal_ValueChanged(object sender, EventArgs e)
        {
            if (locked)
            {
                return;
            }
            tool.DynThreadVal = (double)UpDownDynThreadVal.Value;
        }
        ...
        private void ChangeShowMode(ShowMode showMode)
        {
            ...
            switch (showMode)
            {
                case ShowMode.IncludeROI:
                    groupBoxCreateOCR.Enabled = true;
                    groupBox2.Enabled = true;
                    break;
                case ShowMode.ExcludeROI:
                    groupBoxCreateOCR.Enabled = false;
        ...
        private void UpDownMaxCharHeight_ValueChanged(object sender, EventArgs e)
        {
            ...
            tool.MaxCharHeight = (int)UpDownMaxCharHeight.Value;
        }
        ...
        private void UpDownPartitionCharWidth_ValueChanged(object sender, EventArgs e)
        {
            if (locked)
            {
                return;
            }
            tool.PartitionCharWidth= (int)UpDownPartitionCharWidth.Value;
        }

        private void UpDownCloseR_ValueChanged(object sender, EventArgs e)
        {
            if (locked)
            {
                return;
            }
            tool.CloseCircleRadius= (double)UpDownCloseR.Value;
        }

        private void UpDownOpenR_ValueChanged(object sender, EventArgs e)
        {
            if (locked)
            {
                return;
            }
            tool.OpenCircleRadius = (double)UpDownOpenR.Value;
        }

        private void UpDownMinArea_ValueChanged(object sender, EventArgs e)
        {
            if (locked)
            {
                return;
            }
            tool.MinCharArea= (double)UpDownMinArea.Value;
        }

        private void UpDownMaxArea_ValueChanged(object sender, EventArgs e)
        {
            if (locked)
            {
                return;
            }
            tool.MaxCharArea = (double)UpDownMaxArea.Value;
        }
    }
}
